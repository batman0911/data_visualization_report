...
\begin{center} % Everything within the center environment is centered.
	{\Large \bf Chương 7 - Kỹ thuật trực quan hoá \\ cho dữ liệu hướng thời gian} % <---- Don't forget to put in the right number
	\vspace{2mm}
...
\input{sections/02_definations.tex}
\input{sections/03_vis_time_data.tex}
\input{sections/04_time_bench.tex}
